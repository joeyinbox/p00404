module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {   
			js: {
				files: {
					'js/build/index.min.js': ['js/class/LogicGate.js', 
											  ...
											  'js/class/Quiz.js',
											  'js/index.js'],
					'js/build/build-your-own.min.js': ['js/class/LogicGate.js', 
											  		   'js/class/DualInputGate.js', 
											  		   'js/class/AndGate.js', 
											  		   'js/class/NandGate.js', 
											  		   'js/class/OrGate.js', 
					...
					'js/build/math-to-graphical.min.js': ['js/class/LogicGate.js', 
											  			  'js/class/DualInputGate.js', 
											  			  'js/class/AndGate.js', 
											  			  'js/class/NandGate.js', 
											  			  'js/class/OrGate.js', 
					...
					'js/build/quiz.min.js': ['js/class/LogicGate.js', 
											 'js/class/DualInputGate.js', 
											 'js/class/AndGate.js', 
											 'js/class/NandGate.js', 
											 'js/class/OrGate.js', 
